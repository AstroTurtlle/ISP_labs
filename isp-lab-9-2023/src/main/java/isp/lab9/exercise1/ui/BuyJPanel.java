...
public class BuyJPanel extends JPanel {
    ...
    private void initComponents(){
        ...
        buyButton.addActionListener(e -> buy(symbolComboBox, quantityTextField, costTextField, availableFundsTextField));
    ...
    private void buy(JComboBox<String> symbolComboBox,
        ...
        BigDecimal cash = mainFrame.getPortfolio().getCash();
        try {
            BigDecimal total_cost = calculateTotalCostActionPerformed(symbolComboBox, quantityTextField, totalCostTextField);
            if (total_cost.compareTo(cash) > 0) {
                ...
                String message = "Are you sure you want to buy stocks for $" + total_cost + "?";
                int answer = JOptionPane.showConfirmDialog(null, message);
                if(answer == 0) {
                    mainFrame.getPortfolio().setCash(cash.subtract(total_cost));
     ...
     */
    private BigDecimal calculateTotalCostActionPerformed(JComboBox<String> symbolComboBox,
                                                   JTextField quantityTextField,
                                                   JTextField totalCostTextField) {
        try {
